        ...
        if updatedata is not None:
            values = {
                'current': {
                    ...
                    'windDir': self.deg_to_dir(int(updatedata["current"]["wind_deg"])),
                    ...
                    'nwid': self.to_nwid(updatedata["current"]["weather"][0]["icon"], 
                ...
                'forecast': [
                    {
                        ...
                        'nwid': self.to_nwid(updatedata["daily"][i]["weather"][0]["icon"], 
                ...
                'hourly': [
                    {
                        ...
                        'nwid': self.to_nwid(updatedata["hourly"][i]["weather"][0]["icon"], 
