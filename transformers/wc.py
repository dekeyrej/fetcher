...
class WCServer(MicroService):
    ...
    def __init__(self):
        ...
        self.rset('period:WC', self.update_period) # initialize the period in Redis for the fetcher to read
    ...
    def update(self, updatedata: list[dict]) -> list[dict]:
        ...
        if events is not None:
            ...
            self.rset('period:WC', self.update_period) # update the period in Redis for the fetcher to read
